...
public class StudentController {
	...
	public ResponseEntity<Student> registerStudentInCourseHandler(@PathVariable  String cname, @RequestBody Student student) throws CourseException{
		
		Student enrolledstudent = sService.registerStudentInCourse(cname, student);
		
		return new ResponseEntity<Student>(enrolledstudent,HttpStatus.OK);
	...
	public ResponseEntity<List<Student>> getStudentByCnameHandler(@PathVariable("cname")String cname) throws CourseException{
	 List<Student> st =	sService.findAllStudentByCname(cname);
